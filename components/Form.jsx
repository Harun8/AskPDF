...
const Forms = (props) => {
  ...
  return (
    <>
      ...
      >
        {({ errors, touched }) => (
          <Form className="form rounded w-96 px-8 pt-6 pb-8 mb-4 align-middle mt-60">
...
C318.115,0,375.068,22.126,419.404,58.936z"
            ...
            <p className="p line text-black ">{t("login.orWith")}</p>
            ...
            <p className="p">
              <Link href={props.link} className="span">
                {props.redirect}
              </Link>
            </p>
          </Form>
