...
const Nav = ({ session }) => {
  ...
  return (
    <>
      <nav class="relative px-4 py-4 flex justify-between items-center bg-white dark:bg-gray-800">
        ...
        {!session ? (
          <>
            <Link
              class="hidden md:inline-block md:ml-auto md:mr-3 py-2 px-6 bg-gray-200 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm text-gray-900 dark:text-gray-200 font-bold  rounded-xl transition duration-200"
              href="/login">
              Login
            </Link>
            <Link
              class="hidden md:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 dark:bg-blue-950 dark:hover:bg-blue-800 text-sm text-white font-bold rounded-xl transition duration-200"
              href="/signin">
              Sign up
            </Link>
          </>
