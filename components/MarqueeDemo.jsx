...
export function MarqueeDemo() {
  ...
  return (
    <div className="relative flex p-8 flex-col items-center justify-center overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 from-white"></div>
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 from-white"></div>
    </div>
  );
}
