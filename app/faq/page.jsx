...
const Accordion = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white dark:bg-gray-800 pb-12 pt-20   lg:pb-[90px] lg:pt-[120px]">
  ...
  return (
    <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-gray-800 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8">
      <button
        ...
        <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-blue-500/5 text-blue-600 dark:bg-white/5">
          <svg
            className={`fill-blue-500 stroke-primary duration-200 ease-in-out ${
              active ? "rotate-180" : ""
            }`}
            width="17"
            height="10"
